...
The Digital Climate Strike's Wordpress plugin will allow anyone with a website to join the digital climate strike in solidarity. [Click here to learn more.](https://globalclimatestrike.net)

## How it works & Demo

When you install this plugin an enable the Digital Strike widget via Settings in your Worsdpress admin, it will show a footer banner ([demo](https://assets.digitalclimatestrike.net/demo.html)) informing visitors that your site is supporting the Global Climate Strike and directs them to also join the strike:
